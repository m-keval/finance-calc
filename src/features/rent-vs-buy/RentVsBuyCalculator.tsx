        ...
        <div className="lg:col-span-7 space-y-6">
          <Card className="p-8 border-2 border-indigo-100 dark:border-indigo-900 shadow-sm relative overflow-hidden bg-gradient-to-br from-card to-indigo-50/50 dark:to-indigo-950/20">
            ...
            <p className="text-muted-foreground mb-8 text-lg">
              After {loanTenure} years, <span className="font-bold text-foreground">{results.isBuyingBetter ? "Buying" : "Renting"}</span> is financially better by <span className="font-bold text-indigo-600 dark:text-indigo-400">{formatCurrency(results.difference)}</span>.
            </p>
