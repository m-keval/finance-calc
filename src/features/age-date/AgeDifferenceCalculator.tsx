    ...
    <Card className="p-6 border border-brand-100 dark:border-brand-950">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        <div className="lg:col-span-5 space-y-4">
          <DatePicker label="First Person" value={date1} onChange={setDate1} />
          <DatePicker label="Second Person" value={date2} onChange={setDate2} />
        </div>
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className="p-4 rounded-xl bg-brand-50 dark:bg-brand-950/30 text-center border border-brand-100 dark:border-brand-900">
            ...
            <div className="text-xs text-muted-foreground mt-1">Age Difference</div>
          </div>
