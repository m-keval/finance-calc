...
export const metadata: Metadata = {
  title: "Income Tax Calculator FY 2024-25 (AY 2025-26) | Compare Old vs New Regime",
  description: "Compare Old and New Tax Regimes with Budget 2024 revised tax slabs, Standard Deduction of ₹75,000, Section 87A rebate, and deduction optimizations.",
};
    ...
    <div className="w-full max-w-5xl mx-auto py-4">
      ...
      <div className="mb-4">
        ...
        <p className="text-muted-foreground text-sm sm:text-base max-w-3xl leading-relaxed">
          Accurately calculate your income tax liability and compare the Old vs. New Tax Regime to discover which option maximizes your tax savings.
        </p>
      </div>
