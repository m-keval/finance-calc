...
export const metadata: Metadata = {
  title: "Loan Prepayment Calculator | Reduce EMI Tenure & Interest Savings",
  description: "Calculate how much interest and tenure you save by making extra monthly or annual lump-sum prepayments on your Home Loan.",
};
