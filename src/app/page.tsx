...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {calculators.map((calc, i) => (
              <Link key={i} href={calc.href} className="group flex h-full">
                <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                  <CardHeader>
      ...
      <section id="health-calculators" className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold tracking-tight mb-4">Health Calculators</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">Track your body metrics, plan your diet, and hit your fitness goals with precision.</p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/health/bmi" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <PieChart className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">BMI Calculator</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
            ...
            <Link href="/health/bmr" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <Target className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">BMR Calculator</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
                    Calculate your Basal Metabolic Rate to understand how many calories you burn at rest.
                  </CardDescription>
                </CardContent>
              </Card>
            </Link>
            <Link href="/health/calories" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <Zap className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Calorie Target</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
                    Determine exactly how many calories you need daily to reach your body goals.
                  </CardDescription>
                </CardContent>
              </Card>
            </Link>
            <Link href="/health/body-fat" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <Target className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Body Fat %</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
                    Calculate your body fat percentage using the standard U.S. Navy Method.
                  </CardDescription>
                </CardContent>
              </Card>
            </Link>
            <Link href="/health/ideal-weight" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <PieChart className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Ideal Weight</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
                    Find your clinically healthy ideal weight range based on your height and gender.
                  </CardDescription>
                </CardContent>
              </Card>
            </Link>
            <Link href="/health/water-intake" className="group flex h-full">
              <Card className="flex-1 transition-all duration-300 hover:border-emerald-500/50 dark:hover:border-emerald-500/30 cursor-pointer">
                <CardHeader>
                  <div className="mb-4 inline-flex h-12 w-12 items-center justify-center rounded-lg bg-emerald-100 dark:bg-emerald-900/20 group-hover:bg-emerald-200 dark:group-hover:bg-emerald-900/40 transition-colors">
                    <Zap className="h-6 w-6 text-emerald-500" />
                  </div>
                  <CardTitle className="text-xl group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">Water Intake</CardTitle>
                </CardHeader>
                <CardContent>
                  <CardDescription className="text-base leading-relaxed">
                    Calculate your optimal daily hydration target based on weight and activity.
                  </CardDescription>
                </CardContent>
              </Card>
            </Link>
