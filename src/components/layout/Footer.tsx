        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li><Link href="/calculators/sip" className="hover:text-indigo-600 transition-colors">SIP Calculator</Link></li>
              <li><Link href="/calculators/fd" className="hover:text-indigo-600 transition-colors">Fixed Deposit Calculator</Link></li>
              <li><Link href="/calculators/loan-emi" className="hover:text-indigo-600 transition-colors">Loan EMI Calculator</Link></li>
              <li><Link href="/calculators/inflation" className="hover:text-indigo-600 transition-colors">Inflation Calculator</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-indigo-600 transition-colors">Personal Finance Guide</Link></li>
              <li><Link href="#" className="hover:text-indigo-600 transition-colors">Tax Saving Strategies</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li><Link href="#" className="hover:text-indigo-600 transition-colors">Disclaimer</Link></li>
            </ul>
          </div>
        </div>
